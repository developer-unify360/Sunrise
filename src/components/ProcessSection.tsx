      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-4 justify-center">
            ...
            <span className="text-sky-600 text-xs font-bold uppercase tracking-[0.3em]">How We Work</span>
            <div className="w-8 h-0.5 bg-sky-600" />
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {steps.map((step) => (
            <div
              key={step.num}
              className="group relative bg-white border border-gray-200 hover:border-sky-600 p-8 transition-all duration-300 hover:shadow-xl overflow-hidden"
            >
              <div className="absolute top-4 right-4 text-7xl font-black text-gray-100 leading-none select-none group-hover:text-sky-100 transition-colors">
                {step.num}
              </div>
              <div className="relative z-10">
                <div className="w-14 h-14 border-2 border-sky-600 flex items-center justify-center mb-5 group-hover:bg-sky-600 transition-colors duration-300">
                  <step.icon size={24} className="text-sky-600 group-hover:text-white transition-colors" />
                </div>
                <div className="text-sky-600 text-xs font-black uppercase tracking-widest mb-2">Step {step.num}</div>
