          ...
          {services.map((svc, i) => (
            ...
            >
              <div className={`relative ${i % 2 === 1 ? 'lg:order-2' : ''}`}>
                ...
                />
                <div className="absolute top-6 left-6 w-14 h-14 bg-orange-500 flex items-center justify-center shadow-lg">
              ...
              <div className={i % 2 === 1 ? 'lg:order-1' : ''}>
                <div className="inline-flex items-center gap-2 mb-4">
                  ...
                  <span className="text-orange-500 text-xs font-bold uppercase tracking-[0.3em]">Our Service</span>
                </div>
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold uppercase tracking-widest text-xs px-6 py-3 transition-colors"
                >
