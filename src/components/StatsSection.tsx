...
function StatItem({ icon: Icon, value, suffix, label, desc, active }: typeof stats[0] & { active: boolean }) {
  ...
  return (
    <div className="group text-center px-8 py-10 border-r border-white/20 last:border-0">
      <div className="w-16 h-16 bg-white/10 border-2 border-orange-400 flex items-center justify-center mx-auto mb-5 group-hover:bg-orange-500 transition-colors duration-300">
