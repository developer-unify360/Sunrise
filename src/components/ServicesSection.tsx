      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div>
            <div className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="text-sky-600 text-xs font-bold uppercase tracking-[0.3em]">What We Offer</span>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((svc) => (
            <div
              key={svc.title}
              className="group bg-white border border-gray-200 hover:border-sky-600 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300"
            >
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 w-12 h-12 bg-sky-600 flex items-center justify-center">
                  <svc.icon size={22} className="text-white" />
                </div>
              </div>

              <div className="p-6">
                <h3 className="text-lg font-bold text-gray-900 uppercase tracking-wide mb-3 group-hover:text-sky-600 transition-colors">
                  {svc.title}
                </h3>
                <p className="text-gray-500 text-sm leading-relaxed mb-4">{svc.desc}</p>
                <a
                  href="#contact"
                  className="inline-flex items-center gap-2 text-sky-600 text-xs font-bold uppercase tracking-widest hover:gap-3 transition-all"
                >
